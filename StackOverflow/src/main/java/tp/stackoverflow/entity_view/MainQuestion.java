 ...
 */
public class MainQuestion implements ListViewEntity {
    ...
    public MainQuestion(Answer answer){
        this.body          = answer.getBody();
        this.question_id   = answer.getQuestionId();
        this.creation_date = answer.getDate();
    }

    public MainQuestion(Question question){
        this((Answer)question);
        this.title = question.getTitle();
    }

    public MainQuestion(Answer answer, User user){
        this(answer);
    ...
    public MainQuestion(Question question, User user){
